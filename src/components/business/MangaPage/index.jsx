    ...
    <>
      <div className={styles.mainContainer}>
        <div className={styles.leftColumnContainer}>
          ...
          <div className={styles.actionBTNsContainer}>
            <FaGear />
            <FaFlag
              onClick={() => togglePopup(setShowReportForm, showReportForm)}
            />
            <FaCommentAlt />
            <FaGear />
          </div>
        ...
        <div className={styles.rightColumnContainer}>
          <div className={styles.details}>
            ...
            <div
              onClick={() => togglePopup(setShowRatingForm, showRatingForm)}
          ...
          <div className={styles.chapterListContainer}>
            <div>
              All {chapters.length}{" "}
              {chapters.length > 1 ? "Chapters" : "Chapter"}
            </div>
      ...
      {showReportForm && (
        <div
          ...
          onClick={(e) =>
            handlePopupClick(e.target.id, setShowReportForm, showReportForm)
          }
          id="popupContainer"
        >
          <ReportForm
      ...
      {showRatingForm && (
        <div
          className={styles.popupContainer}
          onClick={(e) =>
            handlePopupClick(e.target.id, setShowRatingForm, showRatingForm)
          }
          id="popupContainer"
        >
          <RatingForm
      ...
      {showNotiForm && (
        <div
          className={styles.popupContainer}
          onClick={(e) =>
            handlePopupClick(e.target.id, setShowNotiForm, showNotiForm)
          }
          id="popupContainer"
        >
          <NotificationForm
